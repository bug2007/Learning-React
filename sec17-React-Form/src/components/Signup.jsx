...
export default function Signup() {
  ...
  function handleSubmit(event) {
    ...
    const fd = new FormData(event.target) // event.target is the form element. use name attribute for all the input fields
    ...
    if (data.password !== data['confirm-password']) {   // had to use square bracket notation as there is a hyphen
